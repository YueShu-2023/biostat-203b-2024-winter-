...
### Completeness, correctness and efficiency of solution: 63/80
...
-   Q3 (13/20)
    ...
    **3.4 output of the provided script?**

    **Header included in patient count**

    **3.7 output did not display**
...
-   Q4 (5/10)
    ...
    **4.1 answer is incomplete. output does not display, and explanation should include more**

    **4.3 output not included**
...
-   If necessary, are there clear instructions, either in report or in a separate file, how to reproduce the results?
    ...
    **Screenshot not included in git for render**
