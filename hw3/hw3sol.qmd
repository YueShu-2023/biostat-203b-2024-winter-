...
ggplot() +
  ...
  geom_point(data = procedures_icd, aes(x = as.POSIXct(chartdate), y = "Procedure",
             shape = icd_code)) +
...
# Read labevents.pq and filter relevant lab measurements
...
# Assuming icustays_tble is already defined and loaded elsewhere in your script
# Ensure subject_id in icustays_tble is of type character for the join
...
labevents %>%
  ...
  # Ensure subject_id is character for compatibility with icustays_tble
  mutate(subject_id = as.character(subject_id),
