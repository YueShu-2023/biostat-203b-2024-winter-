...
mimic_icu_cohort_processed <- mutate(
  mimic_icu_cohort_processed,
  race = fct_collapse(
    race,
...
mimic_icu_cohort_processed <- mimic_icu_cohort_processed %>%
  ...
  select(-subject_id, -hadm_id, -stay_id,-admit_provider_id,
         -intime, -outtime, -admittime, -dischtime, 
         -deathtime, -edregtime, -edouttime,-anchor_age,
         -anchor_year,-anchor_year_group)

summary_table <- tbl_summary(mimic_icu_cohort_processed, 
                             by = los_long)
