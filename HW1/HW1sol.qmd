 ...
 **Answer:**
The output is the 5 lines from the 16th to 20th line of the file. `"$1"` means the pg42671.txt, `"$2"` means the 20th line, and `"$3"` means last fifrh line. We need the first line of the shell script because it tells the system which interpreter to use to execute the script.
